...
class AdaptivePlanner:
    ...
    def plan_initial_workflow(self, task_query, app_name, app_context):
        ...
        {{
            "steps": [
                {{
                    ...
                    "verification": "What should be visible if this succeeds",
        ...
        1. Prefer TEXT-BASED selectors: button:has-text("Create") over [data-testid="..."]
        2. Always provide 2-3 fallback selectors
        3. For critical actions, suggest keyboard shortcuts as fallbacks
        4. Add verification criteria (what should appear after action)
        5. Break complex actions into smaller verifiable steps
        6. Use 'wait' actions after navigation or modal opens
        """
